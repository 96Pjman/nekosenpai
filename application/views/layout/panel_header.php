						...
						<?php foreach ($stats as $udata) {?>
								...
								<div class="ul_list ul_list-icon-ok profile_list  ">
									<ul>
										...
										<li><i class=""></i>Birthday : <span> <?php echo $udata->user_first_name; ?> </span></li>
                ...
                <div class="col-md-12">
							<div class="page-content page-content-user-profile">
								<div class="user-profile-widget">
									<h2><?php echo $_SESSION['user_fname']; ?> <?php echo $_SESSION['user_lname']; ?> Stats</h2>
									...
									<?php foreach ($stats as $stat) {?>
										<ul>
											...
											<li><i class="icon-asterisk"></i>Best Answers<span> ( <span><?php echo $stat->best_answers; ?></span> ) </span></li>
										</ul>
									<?php }?>
									</div>
	...
	<header id="header">
		<section class="container clearfix">
			...
			<nav class="navigation">
				<ul>
					<li class="current_page_item"><a href="<?= base_url('index.php/home') ?>"><i class="icon-home"></i> &nbsp;Cattery</a></li>
					...
					{ if($ad->admin_mail==$_SESSION['user_email']){  ?>
					<li><a href="<?= base_url('index.php/home/admin_potral') ?>"><i class="icon-lock"></i>&nbsp; Admin Portal</a></li>
					<?php }} ?>
				</ul>
			</nav>
		</section><!-- End container -->
